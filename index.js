...
let StringBigestLength = "I am learning Programming to become a programmer";

function string(StringBigestLength) {
    let word = StringBigestLength.split(" ")
    // console.log(word)
    let firstWord = word[0];
    // console.log(firstWord)
    for (let i = 0; i < word.length; i++) {
        if (word[i].length > firstWord.length) {
            firstWord = word[i];
        }
    }
    // console.log(firstWord)
}
string(StringBigestLength)
...
// let obj = Object.keys(studentObj);
// console.log(obj)
